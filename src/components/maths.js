...
class Maths extends Component {
    componentDidMount = () =>{
             ...
             var correctCount = 0;
            var q = [
                  { 'Q':'What is the sum of 130+125+191?', 'A':3,'C':['335','456','446','426'],'optionsType':'radio'},
                  {'Q':'If we minus 712 from 1500, how much do we get?','A':1,'C':['788','778','768','758'],'optionsType':'radio'},
                  {'Q':'What are Even Numbers','A':[2,4,5],'C':['1','2','3','4','6'],'optionsType':'checkbox'},
                  {'Q':'The circumference of the circle is also sometimes called:', 'A':'PERIMETER OF THE CIRCLE','optionsType':'text'},
                  {'Q':'9 x 7 is equal to:', 'A':'63','optionsType':'text'},
                  {'Q':'What is the next prime number after 5?', 'A':2,'C':['6','7','9','11'],'optionsType':'radio'},
                  {'Q':'Find the missing terms in multiple of 3: 3, 6, 9, __, 15', 'A':3,'C':['10', '11','12','13' ],'optionsType':'radio'},
                  {'Q':'9/3 = 3','A':1,'C':['True','False'],'optionsType':'radio'},
                  {'Q':'7+10 = 20','A':2,'C':['True','False'],'optionsType':'radio'}
            ];
                            ...
                            <div className="col-sm-6">
                                <div className="card" id="demo"  style={{borderRadius:'10px'}}>
                                    ...
                                    <div className="card-footer bg-danger">
                                        <button className="btn btn-success btn-lg "><a className="text-white" id="nextlevel" onClick={()=> this.props.history.push('/home?level=3')}>Next Level</a></button>  
                                    </div>
                                </div>
                            </div>
                </div>
