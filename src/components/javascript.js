...
class Javascript extends Component {
    componentDidMount = () =>{
             ...
             var correctCount = 0;
             var q = [
                  { 'Q':'How do you write "Hello World" in an alert box?', 'A':2,'C':['msg("Hello World");','alert("Hello World");','alertBox("Hello World");'],'optionsType':'radio'},
                    {'Q':'What is the Capital of Karnataka?','A':'BANGALORE','optionsType':'text'},
                    {'Q':'What are the colors?','A':[2,3,4],'C':['Jasmine','Red','orange','white','lily'],'optionsType':'checkbox'},
                    {'Q':'How do you create a function in JavaScript?', 'A':3,'C':['function:myFunction()','function = myFunction()','function myFunction()'],'optionsType':'radio'},
                    {'Q':'How to write an IF statement in JavaScript?', 'A':1,'C':['if (i == 5)','if i = 5 then','if i == 5 then'],'optionsType':'radio'},
                    {'Q':'How does a FOR loop start?', 'A':2,'C':['for (i = 0; i <= 5)','for (i = 0; i <= 5; i++)','for i = 1 to 5'],'optionsType':'radio'},
                    {'Q':'What is the correct way to write a JavaScript array?', 'A':3,'C':['var colors = "red", "green", "blue"','var colors = (1:"red", 2:"green", 3:"blue")','var colors = ["red", "green", "blue"]'],'optionsType':'radio'},
                    {'Q':'Am I your friend?','A':1,'C':['Yes','No'],'optionsType':'radio'},
                    {'Q':'Can the dog swim?','A':2,'C':['Yes','No'],'optionsType':'radio'}
              ];
            ...
            <div>
                ...
                <form id="form">
                    ...
                    <div className="row">
                            ...
                            <div className="col-sm-6" style={{borderRadius:'10px'}}>
                                <div className="card" id="demo" >
                                    ...
                                    <div className="card-footer bg-danger">
                                        <button className="btn btn-success btn-lg "><a className="text-white" id="nextlevel" onClick={()=> this.props.history.push('/home?level=2')}>Next Level</a></button>  
                                    </div>
                                </div>
                            </div>
                </div>
